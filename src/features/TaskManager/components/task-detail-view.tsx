    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="border-slate-200 shadow-sm bg-white">
          ...
          <CardContent>
            <div className={cn(
              "inline-flex items-center px-4 py-2 rounded-lg border shadow-sm",
              // @ts-ignore
        ...
        <Card className="border-slate-200 shadow-sm bg-white">
          ...
          <CardContent>
            <div className={cn(
              "inline-flex items-center gap-2 px-4 py-2 rounded-lg border shadow-sm",
              // @ts-ignore
